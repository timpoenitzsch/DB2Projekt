...
namespace CoGaDB {
    ...
    template<class T>
    DictionaryCompressedColumn<T>::DictionaryCompressedColumn(const std::string &name) :
            CompressedColumn<T>(name) {
        //TODO: implement
    }
    ...
    template<class T>
    void DictionaryCompressedColumn<T>::print() const
...
template<class T>
size_t DictionaryCompressedColumn<T>::size() const
...
template<class T>
size_t DictionaryCompressedColumn<T>::getSizeInBytes() const
